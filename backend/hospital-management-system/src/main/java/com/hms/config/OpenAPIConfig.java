...
public class OpenAPIConfig {
    ...
    @Value("${hims.openapi.dev-url}")
    private String devUrl;

    @Value("${hims.openapi.prod-url}")
    ...
    public OpenAPI myOpenAPI () {
        ...
        // Contact
        Contact contact = new Contact().email("hims@gmail.com").name("hims").url("https://www.hims.com");
        ...
        Info info = new Info().title("Tutorial Management API")
                ...
                .termsOfService("https://www.hims.com/terms")
                .license(mitLicense);
