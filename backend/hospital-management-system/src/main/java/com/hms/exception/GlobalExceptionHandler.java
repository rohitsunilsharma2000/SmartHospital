...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleSlotNotFoundException(SlotNotFoundException ex, WebRequest request) {
        return buildErrorResponse(ex.getMessage(), HttpStatus.NOT_FOUND, request);
    }

    // ✅ SlotReservationAlreadyExistsException
    @ExceptionHandler(SlotReservationAlreadyExistsException.class)
    public ResponseEntity<Map<String, Object>> handleSlotReservationAlreadyExistsException(SlotReservationAlreadyExistsException ex, WebRequest request) {
        return buildErrorResponse(ex.getMessage(), HttpStatus.BAD_REQUEST, request);
    }
